...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-gray-950 flex-col border-r border-orange-900/20 hidden md:flex">
      {/* Logo */}
...
const TopBar = () => {
  ...
  return (
    <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200 px-8 py-4 flex justify-between items-center">
      <div>
